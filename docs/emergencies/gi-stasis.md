---
title: 胃肠停滞（GI Stasis / 胀气 / 拒食）
description: 兔兔胃肠停滞的家庭急救——症状识别（蜷缩、磨牙、粪便变小）、家庭处置（运动、按摩、西甲硅油、Critical Care）、何时必须立即就医，以及最大的误区"毛球是元凶"。
lastReviewed: 2026-07-27
---

# 🚨 胃肠停滞（GI Stasis / 胀气 / 拒食）

胃肠停滞（Gastrointestinal Stasis，简称 **GI Stasis**）是兔兔**最常见、最危险**的消化道急症，被 House Rabbit Society 称为"**沉默的杀手（The Silent Killer）**"<cite><a href="#ref1">[1]</a></cite>。

理解原理请先读 [消化系统科普](../digest/)。

## 一、症状识别

### 排便变化（最早期、最客观的信号）
- 粪便**变小、变少**，最终完全停止
- 粪球被**透明或黄色黏液**包裹 → 肠炎信号，**急诊**
- 排出未成形的盲肠便（糊状）—— 注意这**不是真性腹泻**

### 行为变化
- **蜷缩成球**、嗜睡、躲藏
- 对最爱的食物/零食/主人**失去兴趣**
- **大声磨牙**（疼痛信号，区别于满足时的轻磨牙）

### 腹部触诊（轻柔！）
| 触感 | 含义 | 处置 |
|---|---|---|
| **柔软如面团** | 可家庭处理 | 运动 + 按摩 + 西甲硅油 + Critical Care |
| **坚硬如鼓（胀气）** | 可能肠梗阻 | **立即就医，禁止按摩** |
...
- **20 mg/mL 婴儿悬浮液**：首剂 **1 mL（1 cc）**，每**小时 1 次**，连用 **2–3 次**；之后按需 1 mL / 3–8 小时
- 用无针头注射器经口喂入
...
将恢复期草粉（如 **Oxbow Critical Care**、Sherwood Recovery Food）与温水按**体积比 1:2** 混成稀糊状（可加少量婴儿南瓜泥增味，可选），用大号（35 mL）导管尖注射器喂食。

- 坐姿，兔兔仰卧膝上，**头部高于尾部**防呛
- 每次约 1 大管流食 + 3–4 小管水，每 3–4 小时重复
...
- 补水：注射器喂水，或稀释的无味电解质溶液（如 Pedialyte）补电解质；少量稀释苹果汁用于诱导饮水（见[电解质页](../supplies/electrolytes)的稀释要求）
...
3. **恢复期过度激进治疗** —— 兔开始排硬便时，忌深度麻醉下强饲、暴力灌肠、剧烈按摩；按摩安全分界与肝破裂风险病例详见[胀气按摩页](../handling/belly-massage)（依据 Dana Krempels 的病例记录）
...
理解机制 = 理解为什么必须这样做（详见 [后肠发酵原理](../digest/hindgut-fermentation)）：

1. 正常肠蠕动的**主要驱动力是大量不可消化纤维**
2. 纤维不足或厌食 → 蠕动障碍
3. 蠕动停止 → 胃液被持续吸收 → 内容物脱水压实 → 疼痛
4. 疼痛 → 进一步厌食（**恶性循环**）
5. 盲肠排空变慢 → *Clostridium* 增殖 → 产气（胀气、剧痛）+ 致命毒素<cite><a href="#ref3">[3]</a></cite>

**预防永远胜于治疗**：无限量长牧草 + 限颗粒粮 + 减少应激 + 每日观察粪便。
...
<SourceCard
  ...
  accessed="2026-07-27"
  level="vet"
  note="12 小时 EMERGENCY 定义；运动/按摩/Simethicone/Critical Care 操作详解。已 WebFetch 核实。"
/>
...
<SourceCard
  ...
  accessed="2026-07-27"
  level="vet"
  note="毛球是结果非原因；恶性循环机制；手术应作最后手段。已 WebFetch 核实。"
/>
...
<SourceCard
  ...
  accessed="2026-07-27"
  level="vet"
  note="Simethicone 用量、运动、按摩操作。"
/>

<a id="ref7"></a>
<SourceCard
  title="Critical Care Information for Pet Owners"
  author="Oxbow Animal Health"
  url="https://www.oxbowaustralia.com/critical-care-information-for-pet-owners/"
  accessed="2026-07-27"
  level="vet"
  note="强制喂食配制比例与日总量参考。"
/>
