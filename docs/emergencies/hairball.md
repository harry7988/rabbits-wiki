---
title: 毛球症（Trichobezoar）
description: 兔毛球症的真相——毛球是胃肠停滞的结果而非原因。最大误区：用猫化毛膏治毛球。家庭处置与 GI Stasis 相同。
...
**危害**：
1. 腹部绞痛、胀气（兔本能隐藏疼痛，用药后食欲下降反而加重 GI 减缓）
2. 电解质失衡与脱水
3. **油基润滑剂覆盖肠道内壁，削弱维生素吸收**
...
| ✅ 有效 | ❌ 无效/有害 |
|---|---|
| **高纤维饮食**（提摩西草为主，纤维 22%+） | 化毛膏 |
| **充足饮水**（多水碗 + 新鲜含水蔬菜） | 木瓜酶片 |
| **日常梳理**（尤其长毛兔和换毛期） | 矿物油 |
| **鼓励运动** | 高糖"排毛粉" |
...
<a id="ref1"></a>
<SourceCard
  title="Gastrointestinal Diseases of Rabbits（毛球是结果非原因的权威陈述）"
  author="Oglesbee BL & Lord B (2020)"
  url="https://pmc.ncbi.nlm.nih.gov/articles/PMC7258705/"
  accessed="2026-07-27"
  level="vet"
  note="明确『毛球是 GI 蠕动减慢的结果，而非原因』。已 WebFetch 核实。"
/>

<a id="ref2"></a>
<SourceCard
  title="Pinpointing Elusive, Sometimes Fatal Hairballs in Rabbits"
  author="Cornell University College of Veterinary Medicine (2024)"
  url="https://www.vet.cornell.edu/about-us/news/20240621/pinpointing-elusive-sometimes-fatal-hairballs-rabbits"
  accessed="2026-07-27"
  level="vet"
  note="『大多数情况下毛发会无害地通过消化道』；真性梗阻的诊断研究。"
/>
...
<SourceCard
  ...
  accessed="2026-07-27"
  level="vet"
  note="『Rabbits should never be given laxatives』；油基使毛球防水；木瓜酶缺乏证据。已 WebFetch 核实。"
/>
...
<SourceCard
  ...
  accessed="2026-07-27"
  level="vet"
  note="需手术的 GI 梗阻存活率约 47.5%（兽医期刊同行评审）。"
/>
